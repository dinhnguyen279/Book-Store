          ...
          >
            <Grid item xs={12} sm={4}>
              ...
              >
                ...
                sách trực tuyến. Thông qua cửa hàng sách này, người dùng có thể
                tìm kiếm một cuốn sách theo sở thích của mình và sau đó có thể
                thêm vào giỏ hàng và cuối cùng mua bằng giao dịch thẻ tín dụng.
              </Typography>
            </Grid>
            <Grid item xs={12} sm={4}>
              <Box borderBottom={1} className={classes.title}>
